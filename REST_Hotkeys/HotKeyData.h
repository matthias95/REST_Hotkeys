...
namespace resthotkeys 
{
	...
	*/
	...
	/**
	* class representing single hotkey with correspong HTTP request
	*/
	class HotKeyData 
	{
	public:
		...
		/**
		* static const property names for json object extracted from settings
		*/
